define(function(require,exports,module){
    ...
    function filter(filterstr,page){
        ...
        if(arguments[1] == undefined){
            ...
            $get("/api/goods/special_goods",{type:"is_return",num:6,order_by:orderby,order:order,screen:filterstr},function(ret){
                if(ret.status){
                    $(".noAttend").hide();
                    $(".dropDown p").hide();
                    // 搜索框添加数据
            ...
            $get("/api/goods/special_goods",{type:"is_return",page:page,num:6,order_by:orderby,order:order,screen:filterstr},function(ret){
                if(ret.status){
                    $(".noAttend").hide();
                    $(".dropDown p").hide();
                    // 搜索框添加数据
